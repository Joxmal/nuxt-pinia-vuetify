<template>
  ...
  <dialog-form
    ...
    @crear="store.formArea.nombre === 'Sistemas' ?  store.crearReporteSistemas() : store.crearReporte() "
  ...
  >
    <template #contenido>
      <v-container>
        ...
        <v-row v-if="store.formArea.nombre === 'Sistemas'">
          <v-col cols="6">
            <v-select
              label="Actividad"
              density="compact"
  ...
  <v-row align="center" align-content="center" justify="center" class="ga-4">

    <v-btn @click="" class="border-5" color="primary">
      Técnico
    </v-btn>
    <v-btn color="primary">
      Sistemas
